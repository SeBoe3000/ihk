...
200g Butter horizontal unterteilen, leicht überlappend zusammendrücken, mit Mehl weich klopfen, etwas ausrollen 
(Butter muss beweglich sein und darf nicht brechen);
...
3 einfache Touren geben: auf 1cm gegen Faltrichtung ausrollen, 1/3 rechts und links in Mitte klappen, 
mind. 30min kühlen vor nächsten Tour;
1-2 Stunden kühlen");
$s6 = "Formen:<br>";
$s7 = erstelleListeRezept("ol", "Auf 3mm rechteckig ausrollen und zuschneiden: Croissants: 22cm Höhe, 8cm einteilen / 
Gipferl: 17cm Höhe, 11cm einteilen;
...
$s11 = erstelleListeRezept("ol", "Gekühlter Teig oder fertig gerollte Croissants einfrieren (nach anfrieren in Tüte packen) 
--> am Vortag über Kühlschrank auftauen, Teig verarbeiten, aufgehen lassen, backen (Haltbar für max. 2 Monate);
